-- DIWA Internationale - Initialisation des données
-- ON CONFLICT DO NOTHING = idempotent : peut tourner plusieurs fois sans erreur

-- 0. Rôles et Utilisateurs
INSERT INTO roles (id, name) VALUES
(1, 'ROLE_USER'), (2, 'ROLE_MODERATOR'), (3, 'ROLE_ADMIN'),
(4, 'ROLE_CLIENT'), (5, 'ROLE_RECEPTIONNISTE'), (6, 'ROLE_CHEF_TECHNICIEN'),
(7, 'ROLE_TECHNICIEN'), (8, 'ROLE_CHAUFFEUR'), (9, 'ROLE_STOCK')
ON CONFLICT DO NOTHING;

-- Admin (admin123)
INSERT INTO users (id, username, email, password, email_verified, must_reset_password, two_factor_enabled, date_creation, prenom, nom)
VALUES (1, 'admin', 'admin@diwa.tg', '$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.TVuHOn2', true, true, false, CURRENT_TIMESTAMP, 'Admin', 'SYSTEM')
ON CONFLICT DO NOTHING;
INSERT INTO user_roles (user_id, role_id) VALUES (1, 3) ON CONFLICT DO NOTHING;

-- Réceptionniste (password123)
INSERT INTO users (id, username, email, password, email_verified, must_reset_password, two_factor_enabled, date_creation, prenom, nom)
VALUES (2, 'reception', 'reception@diwa.tg', '$2a$10$rP/m.pM.pE9n6Gv2fIu7i.vA4X8yO/O.z9yE5q5wO6kE6wY4k6v2.', true, true, false, CURRENT_TIMESTAMP, 'Julie', 'RECEPTION')
ON CONFLICT DO NOTHING;
INSERT INTO user_roles (user_id, role_id) VALUES (2, 5) ON CONFLICT DO NOTHING;

-- Chauffeur 1 (password123)
INSERT INTO users (id, username, email, password, email_verified, must_reset_password, two_factor_enabled, date_creation, prenom, nom, heure_debut_travail, heure_fin_travail)
VALUES (3, 'chauffeur1', 'chauffeur1@diwa.tg', '$2a$10$rP/m.pM.pE9n6Gv2fIu7i.vA4X8yO/O.z9yE5q5wO6kE6wY4k6v2.', true, true, false, CURRENT_TIMESTAMP, 'Marc', 'CHAUFFEUR', '06:00:00', '18:00:00')
ON CONFLICT DO NOTHING;
INSERT INTO user_roles (user_id, role_id) VALUES (3, 8) ON CONFLICT DO NOTHING;

-- Chauffeur 2 (password123)
INSERT INTO users (id, username, email, password, email_verified, must_reset_password, two_factor_enabled, date_creation, prenom, nom, heure_debut_travail, heure_fin_travail)
VALUES (4, 'chauffeur2', 'chauffeur2@diwa.tg', '$2a$10$rP/m.pM.pE9n6Gv2fIu7i.vA4X8yO/O.z9yE5q5wO6kE6wY4k6v2.', true, true, false, CURRENT_TIMESTAMP, 'Jean', 'CHAUFFEUR', '07:00:00', '19:00:00')
ON CONFLICT DO NOTHING;
INSERT INTO user_roles (user_id, role_id) VALUES (4, 8) ON CONFLICT DO NOTHING;

-- Client de test (password123)
INSERT INTO users (id, username, email, password, email_verified, must_reset_password, two_factor_enabled, date_creation, prenom, nom)
VALUES (5, 'client', 'client@test.tg', '$2a$10$rP/m.pM.pE9n6Gv2fIu7i.vA4X8yO/O.z9yE5q5wO6kE6wY4k6v2.', true, true, false, CURRENT_TIMESTAMP, 'Client', 'TEST')
ON CONFLICT DO NOTHING;
INSERT INTO user_roles (user_id, role_id) VALUES (5, 4) ON CONFLICT DO NOTHING;
