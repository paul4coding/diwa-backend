...
public class AdminController {
    ...
    public ResponseEntity<?> createChauffeur(@RequestBody java.util.Map<String, String> request) {
        ...
        Tg.OSEOR.DIWA.Backend.security.model.Role role = roleRepository
                .findByName(Tg.OSEOR.DIWA.Backend.security.enums.ERole.ROLE_CHAUFFEUR)
    ...
    public static class UserAdminDTO {
        ...
        public UserAdminDTO(Long id, String username, String email, List<RoleDTO> roles,
                boolean emailVerified, String telephone, String prenom, String nom) {
            this.id = id; this.username = username; this.email = email;
            this.roles = roles; this.emailVerified = emailVerified;
            this.telephone = telephone; this.prenom = prenom; this.nom = nom;
        }
    ...
    public static class RoleDTO {
        private Long id;
        private String name;
        public RoleDTO(Long id, String name) { this.id = id; this.name = name; }
        public Long getId() { return id; }
